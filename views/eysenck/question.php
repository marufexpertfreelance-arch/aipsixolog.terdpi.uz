<?php
/**
 * Страница вопроса теста Айзенка
 */
...
<head>
    ...
    <title>Eysenck Testi - Savol <?= $currentQuestion ?></title>
    ...
    <main class="container">
        ...
        <div class="question-card">
            ...
            <div class="question-body">
                <form method="POST" action="/eysenck/answer" id="answerForm">
                    ...
                    <div class="options">
                        <label class="option">
                            <input type="radio" name="answer" value="yes" required
                                <?= ($currentAnswer === 1) ? 'checked' : '' ?>
                                onchange="document.getElementById('answerForm').submit();">
                            <span class="option-radio"></span>
                            <span class="option-icon">✅</span>
                            <span class="option-text">Ha</span>
                        </label>

                        <label class="option">
                            <input type="radio" name="answer" value="no" required
                                <?= ($currentAnswer === 0) ? 'checked' : '' ?>
                                onchange="document.getElementById('answerForm').submit();">
                            <span class="option-radio"></span>
                            <span class="option-icon">❌</span>
                            <span class="option-text">Yo'q</span>
                        </label>
                    </div>

                    <div class="nav-buttons">
                        <?php if ($currentQuestion > 1): ?>
                            <a href="/eysenck/question?q=<?= $currentQuestion - 1 ?>" class="btn btn-secondary">
                                ← Oldingi
                            </a>
                        <?php else: ?>
                            <span></span>
