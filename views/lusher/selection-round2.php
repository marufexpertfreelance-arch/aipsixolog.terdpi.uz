...
<head>
    ...
    <title>Lüscher Testi - 2-bosqich</title>
    ...
    <main class="container">
        <div class="test-card">
            <div class="test-header">
                <h1>2-bosqich: Qaytadan tanlang</h1>
                <p>Yana bir marta ranglarni tanlang</p>
            ...
            <div class="test-body">
                <div class="instruction">
                    <p>🎯 Ranglarni yana bir marta sizga eng yoqadigan tartibda tanlang</p>
                </div>
                
                <form method="POST" action="/lusher/round2" id="colorForm">
