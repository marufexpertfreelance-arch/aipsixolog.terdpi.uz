    ...
    <main class="container">
        <div class="test-card">
            <div class="test-header">
                ...
                <h1>IQ Testi</h1>
                <p>Intellektual qobiliyatlarni baholash uchun test</p>
            </div>
            
            <div class="test-body">
                <p class="test-description">
                    <?= htmlspecialchars($test['description'] ?? 'Bu test sizning mantiqiy fikrlash qobiliyatingizni baholash uchun mo\'ljallangan. Test natijasida siz o\'zingizning IQ darajangizni bilib olasiz.', ENT_QUOTES, 'UTF-8') ?>
                </p>
                ...
                <div class="test-stats">
                    ...
                    <div class="stat-item">
                        <div class="stat-value">4 ta</div>
                        <div class="stat-label">Javob varianti</div>
                    </div>
                </div>
                ...
                <div class="instructions">
                    <h3>📋 Ko'rsatmalar</h3>
                    <ul>
                        <li>Har bir savolga to'g'ri javobni tanlang</li>
                        <li>O'ylab qoling va hal qilganingizdan keyin javob bering</li>
                        <li>Hech qanday savolni o'tkazib yubormang</li>
                        <li>Vaqt cheklanmagan - shoshilmang</li>
                    </ul>
                </div>
                
                <a href="/iq/question?q=1" class="btn-start">
                    🚀 Testni boshlash
                </a>
            </div>
        </div>
